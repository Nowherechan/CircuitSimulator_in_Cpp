...
//填充引脚坐标信息
void andOrLogicGate::fillPosition()
{
...
QRectF andOrLogicGate::boundingRect() const
{
    return QRectF(0,0,100,100);
}

QVector<bool> andOrLogicGate::flash(QVector<bool> input)
{
    //维护旧输入输出
    lastInput = nowInput;
...
void andOrLogicGate::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *)
{
    int baseX = position.x();
    int baseY = position.y();
